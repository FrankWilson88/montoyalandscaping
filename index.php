...
<head>
  ...
  <meta name="description" content="Come see the official home of Montoya Landscaping LLC! The best decision for all of your professional landscaping needs.">
  <meta name="keywords" content="Montoya Landscaping LLC, LLC, Landscaping, Portfolio, Professional, Family Owned, Small Business, Local">
  <link rel="stylesheet" type="text/css" href="css/main.css?version=2">
  <img rel="icon" href="img/montoyaLogo.jpg" type="image/icon type">
  <meta name="robots" content="index follow">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Montoya Landscaping LLC|Home</title>
</head>
<body class="row pc tablet mobile">
  <header>
    <img class="header" src="img/montoyaLogo.jpg" alt="Montoya Logo">
    <a class="headerBtn" href="https://www.facebook.com/Montoya-Landscaping-Services-856645058033759" target="_blank"><img class="headerImg" src="img/facebook.png" alt="facebook icon"></a>
    <a class="headerBtn" href="mailto:montoya18296@gmail.com?subject=Business%20Inquirey" target="_blank"><img class="headerImg" src="img/email.png" alt="email icon"></a>
  </header>
  ...
  <div class="portfolio" id="backtotop">
    <div class="tabWrapper"><img src="img/menuIcon.png" onclick="mobileMenu()" alt="Mobile Menu Icon">
      <div class="tabContent" id="tabContent">
        ...
        <button onclick="tab('tree', this)" class="btn">Tree Removal</button>
        <button onclick="tab('stone', this)" class="btn">Stone Install</button>
        <button onclick="tab('powerwash', this)" class="btn">Power Washing</button>
        <button onclick="tab('hardscape', this)" class="btn">Hardscape</button>
      </div>
    </div>
    <div id="about" class="content">
      ...
      <img src="img/loadOut.jpg" class="right col-6 col-s-6 col-m-12">
      <p><b>How to Contact us:</b></p>
      <ul>
        <li><a href="https://www.facebook.com/Montoya-Landscaping-Services-856645058033759" target="_blank">Message us on Facebook!</a></li>
        <li><a href="tel:4436054933">(443) 605-4933</a></li>
