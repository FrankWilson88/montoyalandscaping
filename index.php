...
<body class="row pc tablet">
  <header>
    ...
    <a class="headerBtn" href="#" target="_blank"><img class="headerImg" src="img/email.png" alt="email icon"></a>
  </header>

  <button id="top" onclick="topFunction()">&#8682;</button>
  ...
  <div class="portfolio">
    ...
    <div id="about" class="content">
      ...
      <img src="img/patio.jpg" class="left col-6 col-s-6">
      ...
      <img src="img/loadOut.jpg" class="right col-6 col-s-6">
      ...
      <p><b>How to Contact us:</b><br>How a client would go about contacting the company for a job.</p>
    </div>
